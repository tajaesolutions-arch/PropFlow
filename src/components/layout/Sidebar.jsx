...
const operationalNav = [
  ['/dashboard', 'Dashboard', LayoutDashboard], ['/properties', 'Properties', Building2], ['/bookings', 'Bookings', CalendarDays], ['/calendar', 'Calendar', CalendarDays], ['/cleaning', 'Cleaning', ClipboardCheck], ['/maintenance', 'Maintenance', Wrench], ['/owners', 'Owners', Home], ['/guests', 'Guests / CRM', Users], ['/reports', 'Reports', BarChart3], ['/inventory', 'Supplies / Inventory', Boxes], ['/team', 'Team', Users], ['/smart-tools', 'Smart Tools / AI', Sparkles], ['/notifications', 'Notifications', Bell], ['/settings', 'Settings', Settings], ['/billing', 'Billing', CreditCard], ['/help', 'Help / Support', HelpCircle]
];
